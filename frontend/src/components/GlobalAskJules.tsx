...
export default function GlobalAskJules() {
  ...
  return (
    ...
    >
      {/* Panel */}
      {isOpen && (
        <div className="mb-4 w-[calc(100vw-3rem)] md:w-[450px] glass-strong rounded-2xl border border-violet/30 shadow-glow-violet overflow-hidden animate-fade-in-up origin-bottom flex flex-col max-w-full">
